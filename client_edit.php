                        ...
                        <form action="code.php" method="POST" style="padding:10px; padding-left: 20px;">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <select name="code" class="form-control" required>
                                    ...
                                    <option value="<?php echo $row['code']; ?>" selected hidden>
                                        <?php echo ucfirst(strtolower($row2['name'])); ?></option>
                                    ...
                                    <option value="<?php echo $row1['state_id']; ?>">
                                        <?php echo ucfirst(strtolower($row1['name'])); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="buyer_name" value="<?php echo $row['buyer_name'] ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="gst" value="<?php echo $row['gst'] ?>" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pan" value="<?php echo $row['pan'] ?>" class="form-control"
