        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    <button style="font-size:14px;" type="button" class="btn mr-3 mb-3 btn-primary" data-toggle="modal"
                            ...
                            <tbody align="center">
                                ...
                                <tr>
                                    ...
                                    <td data-toggle="tooltip"
                                        title="Address: <?php echo htmlspecialchars($row['address']); ?>">
                                        <?php echo htmlspecialchars($row['company_name']); ?></td>
                                    <td><?php echo htmlspecialchars($row['buyer_name']); ?></td>
                                    <td><?php echo htmlspecialchars($row1['code']); ?></td>
                                    <td>
                                        <form action="client_edit.php" method="post">
                                            <input type="hidden" name="edit_id"
                                                value="<?php echo htmlspecialchars($row['buyer_id']); ?>">
                                    ...
                                    <td>
                                        <button type="button"
                                            data-id1="<?php echo htmlspecialchars($row['buyer_id']); ?>"
                                            id="deleteclient" class="btn btn-danger">
                                            <i class="fa fa-trash"></i>
                                        </button>
                                    </td>
                                    <td><?php echo !empty($row['gst']) ? htmlspecialchars($row['gst']) : '-'; ?></td>
                                    <td><?php echo !empty($row['pan']) ? htmlspecialchars($row['pan']) : '-'; ?></td>
                                    <td><?php echo !empty($row['cin']) ? htmlspecialchars($row['cin']) : '-'; ?></td>
                                </tr>
                                <?php
                                }
                                ?>
