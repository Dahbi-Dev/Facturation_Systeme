        ...
        <div class="modal-content">
            ...
            <form action="code.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Address</label>
                        <input type="text" name="address" class="form-control checking_email"
              ...
              // Fetch state codes for the current user
              $state_query = mysqli_query($con, "SELECT * FROM statecode WHERE user_id='$user_id' ORDER BY name ASC");

              if ($state_query) {
                while ($row = mysqli_fetch_assoc($state_query)) {
                  echo '<option value="' . htmlspecialchars($row['state_id']) . '">';
                  echo htmlspecialchars(ucfirst(strtolower($row['name'])));
                  echo '</option>';
                }
              } else {
                echo '<option value="">Error loading state codes</option>';
              }
              ?>
                        </select>
                    </div>
            ...
            <form action="code.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account_number" class="form-control checking_email"
            ...
            <form action="code.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="user_name" class="form-control checking_email"
                    ...
                    <div class="form-group">
                        <label>Address</label>
                        <textarea type="text" name="address" class="form-control" placeholder="Enter Address"
                            required></textarea>
                    </div>
              ...
              ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ph_number" class="form-control" placeholder="Enter Phone Number"
                            required>
                    </div>
...
<div class="modal fade" id="addadmingstprofile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="modal-content">
            ...
            <form action="code.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>State Code</label>
                        <input type="number" maxlength="2" name="code" class="form-control"
