...
<head>
    ...
    <link href="./login/main.d810cf0ae7f39f28f336.css" rel="stylesheet">
    <style type="text/css">
    .jqstooltip {
        position: absolute;
        left: 0px;
            ...
            <div class="h-100 bg-plum-plate bg-animation">
                <div class="d-flex h-100 justify-content-center align-items-center">
                    <div class="mx-auto app-login-box col-4">
                        <div align="center">
                            <h3 style="color:white;"><img src="assets/images/km2h.png">Facture</h3>
                        </div>
                     ...
                     ?>
                                ...
                                <div class="modal-footer clearfix">
                                    ...
                                    <div class="float-right">
                                        <button type="submit" name="loginbtn" class="btn btn-primary btn-lg">Login to
                                            Dashboard</button>
                                    </div>
                                </div>
                                </form>
