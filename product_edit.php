                        ...
                        <form action="code.php" method="POST" style="padding:10px; padding-left: 20px;">
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="edit_product_description"
                                        value="<?php echo $row['product_description'];?>" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="edit_sac" value="<?php echo $row['sac'] ?>"
                                        class="form-control" placeholder="Enter SAC Code">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="edit_rate" value="<?php echo $row['rate'] ?>"
